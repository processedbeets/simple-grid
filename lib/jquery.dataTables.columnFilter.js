...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLength) {
            ...
            if (bIsNumber && !oTable.api().settings().context[0].bAjaxDataGet) {
                ...
                input.keyup(function () {
                    ...
                    oTable.fnFilter('^' + this.value, index, true, false); //Issue 37
                    fnOnFiltered();
                });
            } else {
                input.keyup(function () {
                    ...
                    oTable.fnFilter(this.value, index, regex, smart); //Issue 37
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected, bMultiselect) {
            ...
            if (bMultiselect) {
                ...
                select.change(function () {
                    ...
                    oTable.fnFilter($(this).val(), iColumn);
                    fnOnFiltered();
                });
                if (currentFilter != null && currentFilter != "") {//Issue 81
        ...
        function fnCreateSelect(oTable, aData, bRegex, oSelected, bMultiselect) {
            ...
            if ((aData == null || typeof (aData) == 'function') && ((oSettings.sAjaxSource != "" && !oSettings.oFeatures.bServerSide) || (oSettings.ajax != null))) {
                ...
                oSettings.aoDrawCallback.push({
                    "fn": (function (iColumn, nTh, sLabel) {
                        return function (oSettings) {
                            ...
                            if (oSettings.iDraw == 2 && ((oSettings.sAjaxSource != null && oSettings.sAjaxSource != "" && !oSettings.oFeatures.bServerSide) || (oSettings.ajax != null))) {
                                ...
                                return fnCreateColumnSelect(oTable, aData && aData(oSettings.aoData, oSettings), iColumn, nTh, sLabel, bRegex, oSelected, bMultiselect); //Issue 37
                            }
                        };
                    })(i, th, label),
            ...
            fnCreateColumnSelect(oTable, typeof (aData) == 'function' ? null : aData, i, th, label, bRegex, oSelected, bMultiselect); //Issue 37
        ...
        function fnCreateCheckbox(oTable, aData) {
            ...
            // changed from button to div. DTM
            r += '<div id="' + buttonId + '" class="checkbox_filter btn btn-info btn-block" > ' + labelBtn + '&nbsp;&nbsp;<i class="fa fa-chevron-down"></i></div>'; //filter button witch open dialog
        ...
        return this.each(function () {
            ...
            //            }
            //see https://code.google.com/p/jquery-datatables-column-filter/issues/detail?id=158
